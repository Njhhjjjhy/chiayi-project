// Capture standing, entrance, back, and ceiling views of /fireflies.
// Saves to baselines/<timestamp>-slice3-before-<label>.png.
...
async function capture(view, label) {
  ...
  const outPath = join(outDir, `${ts}-slice3-before-${label}.png`)
