...
import {
  LANTERN_LED_COLOR, LANTERN_LED_EMISSIVE_INTENSITY,
...
const LED_MAT = new THREE.MeshStandardMaterial({
  color: LANTERN_LED_COLOR,
  emissive: LANTERN_LED_COLOR,
  emissiveIntensity: LANTERN_LED_EMISSIVE_INTENSITY,
  toneMapped: false,
  roughness: 0.5,
  metalness: 0,
})

const { leds } = buildLanterns()
...
export default function LanternLEDs() {
