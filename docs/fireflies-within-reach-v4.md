...
- Branches read as forest above a faint warm ground plane.
- Green firefly LEDs above read cold and precise against the warm ground glow.

## Lighting option B: mountain ridge silhouette
...
- Luffa wall warm backlight is the only warm element; everything else is cool.

---

## Stage 1: flicker

- Room already alive; fireflies waking and fading along branches and across panels on their own.
