...
- **Column** — 40 × 40 cm concrete column at the south side of the visitor entrance, full ceiling height. Existing structural element of the venue (not a new build, not plywood). Outer face flush with the entrance-wall line; front face at the south edge of the visitor entrance opening. The visitor entrance is the gap between the column and the front-wall. Component: `Column.jsx`.
